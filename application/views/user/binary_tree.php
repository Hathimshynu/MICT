                        ...
                        <tbody>
                           <tr class="node-cells">
                              <td class="node-cell" colspan="4">
                                 <?php $this->admin->get_genealogyy($sponsor['username'],'user');?>
                              </td>
                           </tr>
                           <tr>
                              <td colspan="4">
                                          ...
                                          <td class="node-cell" colspan="4">
                                             <?php
                                                if (!empty($sponsor['username'])) {
                                                    ...
                                                    if (!empty($cl)) {
                                                        $this->admin->get_genealogyy($cl,'user');
                                                    } else { ?>
                                             <div class="node">
                                                      ...
                                                      <td class="node-cell" colspan="4">
                                                         <?php
                                                            if (!empty($cl)) {
                                                                ...
                                                                if (!empty($cll)) {
                                                                    $this->admin->get_genealogyy($cll,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-container" colspan="2">
                                                         <?php
                                                            if (!empty($cll)) {
                                                                ...
                                                                if (!empty($clll)) {
                                                                    $this->admin->get_genealogyy($clll,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-container" colspan="2">
                                                         <?php
                                                            if (!empty($cll)) {
                                                                ...
                                                                if (!empty($cllr)) {
                                                                    $this->admin->get_genealogyy($cllr,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-cell" colspan="4">
                                                         <?php
                                                            if (!empty($cl)) {
                                                                ...
                                                                if (!empty($clr)) {
                                                                    $this->admin->get_genealogyy($clr,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-container" colspan="2">
                                                         <?php
                                                            if (!empty($clr)) {
                                                                ...
                                                                if (!empty($clrl)) {
                                                                    $this->admin->get_genealogyy($clrl,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-container" colspan="2">
                                                         <?php
                                                            if (!empty($clr)) {
                                                                ...
                                                                if (!empty($clrr)) {
                                                                    $this->admin->get_genealogyy($clrr,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                          ...
                                          <td class="node-cell" colspan="4">
                                             <?php
                                                if (!empty($sponsor['username'])) {
                                                    ...
                                                    if (!empty($cr)) {
                                                        $this->admin->get_genealogyy($cr,'user');
                                                    } else { ?>
                                             <div class="node">
                                                <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                <br>
                                                      ...
                                                      <td class="node-cell" colspan="4">
                                                         <?php
                                                            if (!empty($cr)) {
                                                                ...
                                                                if (!empty($crl)) {
                                                                    $this->admin->get_genealogyy($crl,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-container" colspan="2">
                                                         <?php
                                                            if (!empty($crl)) {
                                                                ...
                                                                if (!empty($crrl)) {
                                                                    $this->admin->get_genealogyy($crrl,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-container" colspan="2">
                                                         <?php
                                                            if (!empty($crl)) {
                                                                ...
                                                                if (!empty($crlr)) {
                                                                    $this->admin->get_genealogyy($crlr,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-cell" colspan="4">
                                                         <?php
                                                            if (!empty($cr)) {
                                                                ...
                                                                if (!empty($crr)) {
                                                                    $this->admin->get_genealogyy($crr,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
                                                      ...
                                                      <td class="node-container" colspan="2">
                                                         <?php
                                                            if (!empty($crr)) {
                                                                ...
                                                                if (!empty($crrr)) {
                                                                    $this->admin->get_genealogyy($crrr,'user');
                                                                } else { ?>
                                                         <div class="node">
                                                            <i style="font-size: 35px" class="fa fa-ban tree_icon add-icon" aria-hidden="true"></i>
                                                            <br>
