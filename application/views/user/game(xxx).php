                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content text-muted">
                                        <div class="tab-pane active" id="home1" role="tabpanel">
                                            ...
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#WinModal">Win</button>
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#LostModal">Loss</button>
                                                       ...
                                                       <div class="card m-1 m-sm-1 m-md-3 m-lg-4 m-xl-4 m-xxl-4" style="width: 18rem;height:12rem;">
                                                         ...
                                                         <div class="card m-1 m-sm-1 m-md-3 m-lg-4 m-xl-4 m-xxl-4" style="width: 18rem;height:12rem;">
                                                          <div class="card-body text-center p-4">
                                                            ...
                                                            <button type="button" class=" button btn btn-sm btn-success waves-effect waves-light me-1 edit_btn" data-status="green" style="background:#180b7c!important;border-color:#228b22!important" id="joinRedBtn" data-bs-toggle="modal" data-bs-target="#varyingcontentModal" data-bs-whatever="@mdo">Deposit</button>
                                                            </h5>
                                                          </div>
                                                        </div>
                                                        </div>
