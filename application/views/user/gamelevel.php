...
<?php include 'header.php';?>
      ...
      <div class="row">
          <div class="col-lg-12">
             <div class="card" style="overflow:auto">
                 <div class="card-header">
                    <h4 class="card-title mb-0">Gaming Level Income</h4>
                </div>
        ...
        <tbody>
     <?php $his= $this->db->where('username',$this->session->userdata('micusername'))->where('remark','Game Level Income')->get('account')->result_array(); 
