                ...
                <div class="card-heading forex-card">
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="align-items-center me-3">
                             <div class="avatar">
                                 <i style="font-size: 32px !important;" class="fa-brands fa-bitcoin trophy-icon"></i>
                             </div>
                        </div> 
                        <div class="align-items-center text-center">
                            <h3 class="price-show">CRYPTO</h3>
                            <!--<h5 class="text-white">1-Step</h4>-->
                            <!--<p class="text-secondary">Evaluation</p>-->
                        </div>    
                    </div>
                </div>
                 <?php  $crypto =  $this->db->select_sum('usdt')->where('username', $this->session->userdata('micusername'))->where('type','Crypto')->get('deposit')->row()->usdt + 0;
              $crypto_today = $this->db->select_sum('usdt')
                 ...
                 ?>
                  <div class="card-body">
                      <div class="amount-container d-flex justify-content-center align-items-center">
                          <p class="total-invested-amount"><span class="text-white me-1">Amount :</span><span style="font-size:21px !important;"></span><span class=""><?=$crypto;?> USDT</span></p>
                      </div>
                     ...
                     <div class="pack-container mt-3">
                         <div class="pack-details d-flex justify-content-between align-items-center">
                             ...
                             <p class="pack-features"><?=$crypto;?> USDT</p>
                         </div>
                         <hr class="horizontal-ruler">
                         <!--<div class="pack-details d-flex justify-content-between align-items-center">-->
                         <!--    <p class="pack-features">Time</p>-->
                         <!--    <p class="pack-features">Unlimited</p>-->
                         <!--</div>-->
                         <!-- <hr class="horizontal-ruler">-->
                         <!-- <div class="pack-details d-flex justify-content-between align-items-center">-->
                         <!--    <p class="pack-features">Profit Amount</p>-->
                         <!--    <p class="pack-features">$ 0</p>-->
                         <!--</div>-->
                         <!-- <hr class="horizontal-ruler">-->
                          <div class="pack-details d-flex justify-content-between align-items-center">
                             <p class="pack-features">Today's Profit</p>
                             <p class="pack-features"><?=$crypto_today;?> USDT</p>
                         </div>
                          <hr class="horizontal-ruler">
                         <!-- <div class="pack-details d-flex justify-content-between align-items-center">-->
                         <!--    <p class="pack-features">Daily Drawdown</p>-->
                         <!--    <p class="pack-features">4%</p>-->
                         <!--</div>-->
                         <!-- <hr class="horizontal-ruler">-->
                         <!-- <div class="pack-details d-flex justify-content-between align-items-center">-->
                         <!--    <p class="pack-features">EA's</p>-->
                         <!--    <p class="pack-features">Allowed</p>-->
                         <!--</div>-->
                         <!-- <hr class="horizontal-ruler">-->
                          <div class="pack-details d-flex justify-content-between align-items-center">
                          ...
                          <hr class="horizontal-ruler">
                         <!-- <div class="pack-details d-flex justify-content-between align-items-center">-->
                         <!--    <p class="pack-features">Minimum Days</p>-->
                         <!--    <p class="pack-features">None</p>-->
                         <!--</div>-->
                         <!-- <hr class="horizontal-ruler">-->
                         <!-- <div class="pack-details d-flex justify-content-between align-items-center">-->
                         <!--    <p class="pack-features">Upgrade To Live</p>-->
                         <!--    <p class="pack-features">72h</p>-->
                         <!--</div>-->
                         <!-- <hr class="horizontal-ruler">-->
                         <!-- <div class="pack-details d-flex justify-content-between align-items-center">-->
                         <!--    <p class="pack-features">Price</p>-->
                         <!--    <p class="pack-features">$597</p>-->
                         <!--</div>-->
                         <!-- <hr class="horizontal-ruler">-->
                         ...
                         <!--         <button style="background-color:transparent!important;" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">-->
                         <!--           Level Members' List-->
                         <!--         </button>-->
                         <!--       </h2>-->
                         <!--       <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">-->
                         <!--         <div class="accordion-body">-->
                         <!--               <p  class="pack-features">John Doe</p>-->
                         <!--               <hr style="color:black !important;" class="horizontal-ruler">-->
                         <!--                <p  class="pack-features">John Doe</p>-->
                         <!--               <hr style="color:black !important;" class="horizontal-ruler">-->
                         <!--                <p  class="pack-features">John Doe</p>-->
                         <!--               <hr style="color:black !important;" class="horizontal-ruler">-->
                         ...
                         <!--   <hr class="horizontal-ruler">-->
                            ...
                            <!--  <div class="accordion-item">-->
                            <!--    <h2 class="accordion-header" id="headingOne">-->
                            <!--      <button style="background-color:transparent!important;" class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#investedAmount" aria-expanded="true" aria-controls="collapseOne">-->
                            <!--        Invested Amount List-->
                            <!--      </button>-->
                            <!--    </h2>-->
                            <!--    <div id="investedAmount" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">-->
                            <!--      <div class="accordion-body">-->
                            <!--            <p  class="pack-features">$300</p>-->
                            <!--            <hr style="color:black !important;" class="horizontal-ruler">-->
                            <!--             <p  class="pack-features">$300</p>-->
                            <!--            <hr style="color:black !important;" class="horizontal-ruler">-->
                            <!--             <p  class="pack-features">$300</p>-->
                     ...
                     <div class="mt-3 d-flex justify-content-between align-items-center">
                         <a href="<?=BASEURL?>user/investment/crypto"><button class="btn btn-primary btn-glow rounded-pill">Invest</button></a>
                         <a href="<?=BASEURL?>user/trading_history_view"><p class="history-label"><i class="fa-solid fa-arrow-right-long me-2"></i>History</p></a>
                     </div>
                     <?php } else{ ?>
                                          <div class="mt-3 d-flex justify-content-between align-items-center">
