...
<!--          <div class="footer-body">-->
              ...
              <!--    <li class="list-inline-item"><a href="extra/privacy-policy.html" class="text-white">Privacy Policy</a></li>-->
...
<footer class="fixed-footer">
  <div class="icon-wrapper">
    <a href="<?=BASEURL?>user/dashboard" class="footericon"><i class="fas fa-home"></i>Dashboard</a>
   <a href="<?=BASEURL?>user/investment" class="footericon"><i class="fas fa-line-chart"></i>AI Trade</a>
    <a href="<?=BASEURL?>user/stack" class="footericon"><i class="fas fa-usd  "></i>Stacking</a>
    <a href="<?=BASEURL?>user/game" class="footericon"><i class="fas fa-gamepad"></i>Game</a>
  </div>
</footer>
<?php 
