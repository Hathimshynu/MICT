...
@media screen and (max-width:500px){
 ...
 @keyframes slideRight {
   ...
   .shining-card:after {
    ...
    height: 2px;
    width: 100px;
    background: linear-gradient(50deg, #180b7c, transparent)!important;
}
...
.shining-card:before {
    ...
    height: 100px;
    width: 2px;
    background: linear-gradient(100deg, #180b7c, transparent)!important;
}
.custom-popup-class {
...
<!-- TradingView Widget END -->
         ...
         <div class="card shining-card">
            <div class="card-body ">
                ...
                <svg height="30px" width="30px" version="1.1" id="_x36_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#000000">
                  ...
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$E_wallet;?> <span class="text-dark ms-1" style="margin-left:3px;">USDT</span></h4>
         ...
         <div class="card shining-card">
            <div class="card-body">
                ...
                <div class="col-2">
                  ...
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$acou_bal;?><span style="font-size:12px; color:#fff;">USDT</span></h4>
               </div>
            </div>
            </div>
         </div>
            ...
            <div class="card-body px-lg-3">
              <div class="row d-flex align-items-center">
                <div class="col-2">
                  ...
                  <div class="col">
             <?php $teamCount=$this->db->like('team',$this->session->userdata('micusername'))->count_all_results('uni_tree'); 

             
             ?>
           
                  <h4 class="pt-3">My Team</h4>
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$teamCount;?></h4>
               </div>
            </div>
            </div>
            </div>
      ...
      <div class="col-lg-4">
         <div class="card shining-card">
            <div class="card-body">
               <div class="row d-flex align-items-center">
                <div class="col-2">
                  <svg fill="#825af9" width="30px" height="30px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" stroke="#825af9">
                     <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                     <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                     <g id="SVGRepo_iconCarrier">
            ...
            <div class="card-body">
               <div class="row d-flex align-items-center">
                <div class="col-2">
                  ...
                  <h4 class="pt-3">Gaming Wallet</h4>
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$game_bal;?></h4>
               </div>
               </div>
               </div>
            </div>
               ...
               <div class="row d-flex align-items-center">
                <div class="col-2">
                 ...
                 <?php $trade_bal =  $this->db->select("(SUM(credit) - SUM(debit)) as balance")->where('user_id', $this->session->userdata('micusername'))->get('trading_wallet')->row()->balance + 0;?>
                  <h4 class="pt-3">AI Trading Wallet</h4>
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$trade_bal;?></h4>
               </div>
               </div>
               </div>
            </div>
            ...
            <div class="card-body">
               <div class="row d-flex align-items-center">
                <div class="col-2">
                  ...
                  <div class="col">
                   <?php $trade_profit =  $this->db->select("(SUM(credit)) as balance")->where('remark','Trade Profit')->where('username', $this->session->userdata('micusername'))->get('account')->row()->balance + 0;?>
                  <h4 class="pt-3">AI Trading Profit</h4>
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$trade_profit?></h4>
               </div>
               </div>
               </div>
            </div>
            ...
            <div class="card-body">
               <div class="row d-flex align-items-center">
                <div class="col-2">
                  ...
                  <div class="col">
                  <?php $stack_profit =  $this->db->select("(SUM(credit)) as balance")->where('remark','Stacking Income')->where('username', $this->session->userdata('micusername'))->get('account')->row()->balance + 0;?>
                  <h4 class="pt-3">My Stacking Profit</h4>
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$stack_profit?></h4>
               </div>
               </div>
               </div>
            </div>
            ...
            <div class="card-body">
               <div class="row d-flex align-items-center">
                <div class="col-2">
                  ...
                  <div class="col">
                   <?php $level_com =  $this->db->select("(SUM(credit) - SUM(debit)) as balance")->where('remark','Trade Level Income')->where('username', $this->session->userdata('micusername'))->get('account')->row()->balance + 0;?>
                  <h4 class="pt-3">AI Level Commision</h4>
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$level_com?></h4>
               </div>
               </div>
               </div>
            </div>
            ...
            <div class="card-body">
               <div class="row d-flex align-items-center">
                <div class="col-2">
                  ...
                  <div class="col">
                  <?php $game_level_com =  $this->db->select("(SUM(credit) - SUM(debit)) as balance")->where('remark','Game Level Income')->where('username', $this->session->userdata('micusername'))->get('account')->row()->balance + 0;?>
                  <h4 class="pt-3">Gaming Level Commission</h4>
                  <h4 class="counter mt-2" style="visibility: visible;"><?=$game_level_com?></h4>
               </div>
               </div>
               </div>
            </div>
   ...
   <div class="mobile mt-2 mb-1 mobile-screen-card">
        <div class="app">
             ...
             <div class="appcard-body ">
                <div class="approw d-flex align-items-center">
                   ...
                   <div class="col p-1 m-1 ">
                      <h4 class="pt-3">E-Wallet</h4>
                       <h4 class="counter mt-2" style="visibility: visible;"><span class="text-dark ms-1" style="margin-left:3px;"><?=$E_wallet;?>USDT</span></h4>
          ...
          <div class="card ">
             <div class="appcard-body ">
                <div class="approw d-flex align-items-center">
                   ...
                   <div class="col p-1 m-1">
                   <h4 class="pt-3">Withdraw Wallet</h4>
                   <h4 class="counter mt-2" style="visibility: visible;"><?=$acou_bal?> <span class="text-dark ms-1">USDT</span></h4>
                </div>
             </div>
          </div>
       </div>
 ...
 <div class="col-6 col-6-sm-screen">
      <div class="card">
         <div class="appcard-body ">
            <div class="approw d-flex align-items-center">
               <div class="col-1 m-1">
<svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M10 16V14.0003M10 14.0003V12M10 14.0003L12 14.0005M10 14.0003L8 14M21 12V11.2C21 10.0799 21 9.51984 20.782 9.09202C20.5903 8.71569 20.2843 8.40973 19.908 8.21799C19.4802 8 18.9201 8 17.8 8H3M21 12V16M21 12H19C17.8954 12 17 12.8954 17 14C17 15.1046 17.8954 16 19 16H21M21 16V16.8C21 17.9201 21 18.4802 20.782 18.908C20.5903 19.2843 20.2843 19.5903 19.908 19.782C19.4802 20 18.9201 20 17.8 20H6.2C5.0799 20 4.51984 20 4.09202 19.782C3.71569 19.5903 3.40973 19.2843 3.21799 18.908C3 18.4802 3 17.9201 3 16.8V8M18 8V7.2C18 6.0799 18 5.51984 17.782 5.09202C17.5903 4.71569 17.2843 4.40973 16.908 4.21799C16.4802 4 15.9201 4 14.8 4H6.2C5.07989 4 4.51984 4 4.09202 4.21799C3.71569 4.40973 3.40973 4.71569 3.21799 5.09202C3 5.51984 3 6.0799 3 7.2V8" stroke="#825af9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>                    </div>
               <div class="col p-1 m-1 ">
                 
                  
                     <h4 class="pt-3">Gaming Wallet</h4>
                     <h4 class="counter mt-2 p-2" style="visibility: visible;"><?=$game_bal;?></h4>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="appcard-body ">
            <div class="approw d-flex align-items-center">
               ...
               <div class="col p-1 m-1 ">
                     ...
                     <h4 class="pt-3">AI Trading Wallet</h4>
                     <h4 class="counter mt-2 p-2" style="visibility: visible;"><?=$trade_bal;?></h4>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="appcard-body ">
            <div class="approw d-flex align-items-center">
               ...
               <div class="col p-1 m-1 ">
                  ...
                  <?php $stack_bal =  $this->db->select("(SUM(credit) - SUM(debit)) as balance")->where('user_id', $this->session->userdata('micusername'))->get('stacking_wallet')->row()->balance + 0;?>
                     <h4 class="pt-3">My Stacking Wallet</h4>
                     <h4 class="counter mt-2" style="visibility: visible;"><?=$stack_bal;?></h4>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="appcard-body ">
            <div class="approw d-flex align-items-center">
               ...
               <div class="col p-1 m-1 ">
                     ...
                     <h4 class="pt-3">Gaming Level Commision</h4>
                     <h4 class="counter mt-2" style="visibility: visible;"><?=$game_level_com;?></h4>
            </div>
         </div>
      </div>
...
<script>
const checkbox = document.getElementById('SwitchCheck13');
checkbox.addEventListener('change', function() {
    if (this.checked) {
        Swal.fire({
            title: 'Do you want to enable Trading AI?',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo base_url('user/update_trading_status'); ?>',
                    type: 'POST',
                    data: { status: 'Enable' },
                    dataType: 'json',
                    success: function(response) {
                        Swal.fire({
                            ...
                            // Disable the checkbox after enabling
 ...
 <?php
  $note = $this->db->where('status',1)->get('notification')->row_array();
  if(!empty($note)){
  ?>
  
  <script>
      Swal.fire({
        imageUrl: '<?=BASEURL?>assets/notification/<?=$note['image']?>', // Replace with the path to your image
        imageAlt: '<?=$note['title']?>', // Replace with the alt text for your image
